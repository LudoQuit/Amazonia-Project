				...
				<table class="table">
					<tr>
						<td style="background-color: #3B5565;">
							<h4 class="entete" style="color: white;">Catégorie :</h4>
						</td>
						<td>
							<a href=""><h4 class="entete">Féraille ou trésor</h4></a>
						</td>
						<td>
							<a href=""><h4 class="entete">Bon pour le Musée</h4></a>
						</td>
						<td>
							<a href=""><h4 class="entete">Accessoires VIP</h4></a>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td>
							<a href=""><h4 class="entete">Enchères</h4></a>
						</td>
						<td>
							<a href=""><h4 class="entete">Achat immédiat</h4></a>
						</td>
						<td>
							<a href=""><h4 class="entete">Meilleure offre</h4></a>
						</td>
					</tr>
					<tr>
						<td></td>
