...
<html>
<head>
	<title>Amazonia :: Inscription</title>
	<meta charset="utf-8">
	<!--BOOTSTRAP-->
		...
		<div class="row">
			<div class="col-md-3" id="sommaire">
				...
				<form name="Filtre" action="" method="post"><table class="table">
					...
					<!--bouton de filtre-->
					<tr><td align="right"><input type="submit" name="filtrer" value="Filtrer"></td></tr>
				</table></form>
			</div>
			...
			<div class="col-md-9" id="contenu">
				...
				<div class="cadre">
					<form id="formclient" action="php_inscription.php" method="post">
						<br>
						<?php
                			if(isset($_GET['err'])){
                    			$error = $_GET['err'];
                        		...
                        		if($error==4){
                        			echo "<p style='color:red'>Veuillez choisir un mot de passe.</p>";
                        		}
                        		if($error==5){
						...
						<table class="table" align="center">
							...
							<tr>
								<td><p>Entrez de nouveau votre mot de passe :</p></td>
								<td colspan="2"><input type="password" name="pwbis" style="width: 300px;"></td>
							</tr>
							<tr>
								<td colspan="3" align="center"><input type="submit" name="inscription" value="S'inscrire"></td>
							</tr>
						</table>
					</form>
				</div>
