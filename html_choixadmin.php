	...
	<div class="container-fluid">
		...
		<div class="row">
			<!--LOGO DE AMAZONIA QUI RENVOIE A L'ACCEUIL-->
 			...
 			<div class="col-md-1" style="height:100px; background-color:#3B5565;">
				<h4 class="menu"><a class="clickmenu" href="html_choixadmin.php"><img src="admin.gif" class="imgmenu" alt="admin">Admin</a></h4>
 			</div>
		</div>
			...
			<div class="col-md-9" id="contenu">
				...
				<table class="table" style="margin-top: 10px;">
					<tr style="background-color: #3B5565;">
						<td align="center">
							<input style="border:3px solid #3B5565; border-radius: 3px;background-color: white;color: #3B5565; width: 180px; padding: 0px"  type="submit" name="vendeur" value="Vendeurs">
						</td>
						<td align="center">
